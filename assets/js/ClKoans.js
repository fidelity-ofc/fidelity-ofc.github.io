...
function GetKoan()
{
    var koans = new Array("Knock Knock. <br> Who's there? <br> Who. <br> Who who? <br> I didn't know you.", "Why did the traffic light turn red? <br> You would too.", "What did Ben Franklin say when he flew a kite in a storm? <br> He didn't say anything.", "How do billboards talk? <br> They use language.", "How do angels greet people?", "What goes up and never comes down? <br> You.", "Why was the boy sitting on his watch?<br> He wanted to be.", "How do you make a fire with two sticks? <br> You make one.", "Which hand is it better to write with? <br> Neither hand.", "Why did the kid like learning math? <br> He thought it was real.","What do two oceans do when they meet? <br> Nothing.", "First snake: Are we poinsonous? <br> Second snake: I don't know.", "What's harder to catch the faster you run? <br> You.");
